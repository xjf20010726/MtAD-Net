...
def main(args):
    ...
    train_thr_dirs=['/home/XJF/code/HRSID/data/train/threshold_0','/home/XJF/code/HRSID/data/train/threshold_1',
              '/home/XJF/code/HRSID/data/train/threshold_2','/home/XJF/code/HRSID/data/train/threshold_3',
              '/home/XJF/code/HRSID/data/train/threshold_4']
    training_data=my_dataset.MYDataset(
        annotations_file="/home/XJF/code/HRSID/data/train.txt",
        img_dir="/home/XJF/code/HRSID/data/train/img",
        threshold_dirs=train_thr_dirs,
        transform=transform,
        target_transform=transform1
    )
    test_thr_dirs=['/home/XJF/code/HRSID/data/test/threshold_0','/home/XJF/code/HRSID/data/test/threshold_1',
              '/home/XJF/code/HRSID/data/test/threshold_2','/home/XJF/code/HRSID/data/test/threshold_3',
              '/home/XJF/code/HRSID/data/test/threshold_4']


    testing_data=my_dataset.MYDataset(
        annotations_file="/home/XJF/code/HRSID/data/test.txt",
        img_dir="/home/XJF/code/HRSID/data/test/img",
        threshold_dirs=test_thr_dirs,
        transform=transform,
        target_transform=transform1
    )
    train_dataloader = DataLoader(training_data, batch_size=args.batch_size,num_workers=24,shuffle=True)
    test_dataloader = DataLoader(testing_data, batch_size=args.batch_size,num_workers=24,shuffle=False)
    ...
    writer = SummaryWriter('runs/HRSID')
    #训练模型
    val=0
    early_stop=0
...
if __name__ == "__main__":
    ...
    parser.add_argument('--tmp',default=15,type=int)
    parser.add_argument('--tau_train',default=2,type=int)
    parser.add_argument('--tau_test',default=4,type=int)
    parser.add_argument('--device',default='cuda:0',type=str)
    parser.add_argument('--result',default='/home/XJF/code/HRSID/results/Model/',type=str)
    ...
    parser.add_argument('--fig_save_path',default="/home/XJF/code/HRSID/results/fig_results_finetune_2",type=str)
