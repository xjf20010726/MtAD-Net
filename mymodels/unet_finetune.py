...
class UNet_Leight(nn.Module):
    def __init__(self, in_channel, channel_nums) -> None:
        super().__init__()
        #[16,32,64,128,256]
        ...
        self.up3=UpConv(channel_nums[2],channel_nums[2],channel_nums[2])
